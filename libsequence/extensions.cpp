...
#define __PYX_HAVE__libsequence__extensions
#define __PYX_HAVE_API__libsequence__extensions
#include <vector>
#include "ios"
#include "new"
#include "stdexcept"
...
static std::vector<Sequence::polySiteVector>  __pyx_convert_vector_from_py_Sequence_3a__3a_polySiteVector(PyObject *); /*proto*/
#define __Pyx_MODULE_NAME "libsequence.extensions"
int __pyx_module_is_main_libsequence__extensions = 0;

/* Implementation of 'libsequence.extensions' */
...
static int __pyx_pf_11libsequence_10extensions_10simDataVec_4__init__(struct __pyx_obj_11libsequence_10extensions_simDataVec *__pyx_v_self, std::vector<Sequence::polySiteVector>  __pyx_v_p) {
  ...
  __pyx_t_11libsequence_14polysitevector_psite_vec_itr __pyx_v_b;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
...
static std::vector<Sequence::polySiteVector>  __pyx_convert_vector_from_py_Sequence_3a__3a_polySiteVector(PyObject *__pyx_v_o) {
  std::vector<Sequence::polySiteVector>  __pyx_v_v;
  PyObject *__pyx_v_item = NULL;
  std::vector<Sequence::polySiteVector>  __pyx_r;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  Py_ssize_t __pyx_t_2;
  PyObject *(*__pyx_t_3)(PyObject *);
  PyObject *__pyx_t_4 = NULL;
  Sequence::polySiteVector __pyx_t_5;
  __Pyx_RefNannySetupContext("__pyx_convert_vector_from_py_Sequence_3a__3a_polySiteVector", 0);

  /* "vector.from_py":52
 * cdef vector[X] __pyx_convert_vector_from_py_Sequence_3a__3a_polySiteVector(object o) except *:
 *     cdef vector[X] v
 *     for item in o:             # <<<<<<<<<<<<<<
 *         v.push_back(X_from_py(item))
 *     return v
 ...
 * 
 */
    __pyx_t_5 = __pyx_convert_vector_from_py_Sequence_3a__3a_polymorphicSite(__pyx_v_item); if (unlikely(PyErr_Occurred())) __PYX_ERR(1, 53, __pyx_L1_error)
    __pyx_v_v.push_back(__pyx_t_5);
 ...
 */
  ...
  /* "vector.from_py":50
 * 
 * @cname("__pyx_convert_vector_from_py_Sequence_3a__3a_polySiteVector")
 * cdef vector[X] __pyx_convert_vector_from_py_Sequence_3a__3a_polySiteVector(object o) except *:             # <<<<<<<<<<<<<<
 *     cdef vector[X] v
 *     for item in o:
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("vector.from_py.__pyx_convert_vector_from_py_Sequence_3a__3a_polySiteVector", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_item);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_libsequence__extensions) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "libsequence.extensions")) {
      if (unlikely(PyDict_SetItemString(modules, "libsequence.extensions", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init libsequence.extensions", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init libsequence.extensions");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
